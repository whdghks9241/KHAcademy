...
public class Comparison {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 비교 연산자의 결과 값은 참(true) 또는 거짓(false_)으로 반환
		  > 왼쪽 항이 크면 참, 아니면 거짓을 반환(미만 초과) ex) num > 5 
		  < 왼쪽 항이 작으면 참, 아니면 거짓을 반환(미만 초과) ex) num < 5
		  >= 왼쪽 항이 오른쪽 항보다 크거나 같으면 참, 아니면 거짓을 반환 (이상 이하) ex) num >= 5
		  <= 왼쪽 항이 오른쪽 항보다 작거나 같으면 참, 아니면 거짓을 반환 (이상 이하) ex) num <= 5
		...
		boolean isEqual1 = p != q; // p와q의 값이 다르게 나오기 때문에 true
